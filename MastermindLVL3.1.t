...
setscreen ("graphics:1300;950,nobuttonbar")
...
loop
    ...
    font3 := Font.New ("TimesNewRoman:40")
    Font.Draw ("Settings", 500, 850, font1, 100)
    locate (5, 1)
    color (46)
    ...
    put "\nB. Input the length of the code to be set:  "
    get len
    ...
    %The Game :))))
    Draw.FillBox (1000, 500, maxx, maxy, 100)
    ...
    put "Length of code to be guessed is:  ", len
	...
	%put "rightplaces"
      put Text.WhatCol
      put Text.WhatRow
	    Draw.FillOval (Text.WhatCol * 200, Text.WhatRow * 20, 25, 25, brightred)
	    %Draw.FillOval (800, yy, 25, 25, brightred)
	    %put yy
       ...
       % put "wrongplaces:  "
	%  for t : 1 .. wrongplace
	 %   Draw.FillOval (800, 600, 25, 25, brightgreen)
	   % size1 := size1 - 50
       % end for
